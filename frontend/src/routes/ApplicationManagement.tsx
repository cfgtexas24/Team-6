...
const ApplicationManagement: FC = () => {
  ...
  const [jobType, setJobType] = useState<
    "all" | "Intern" | "Full-time" | "Part-time"
  >("all");
  ...
  return (
    <>
      ...
      <div className="job-board flex flex-col p-8 bg-white">
        <h1 className="text-4xl font-bold text-[#FEC10E] mb-6">
        ...
        <div className="flex mb-6">
          <div className="relative w-3/4 mr-4">
            <input
              ...
              className="w-1/2 space-x-4 border border-gray-300 rounded-full p-3 pl-5 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-[#FEC10E] transition-all"
            />
          </div>
            ...
            {["All", "Intern", "Full-time", "Part-time"].map((type) => (
              <button
                ...
                className={`w-28 px-4 py-3 rounded-full transition-all ${
                  jobType === type
                    ? "bg-[#FEC10E] text-white font-bold shadow-lg"
                    : "bg-white border border-gray-300"
                } hover:bg-[#FEC10E] hover:text-white`}
              >
        ...
        <div className="flex w-full">
          ...
          {/* Job Details */}
          <div
            className="job-details w-1/2 pl-4 overflow-auto"
            style={{ maxHeight: "600px" }}
          >
            {selectedJob ? (
              <div className="p-4">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  />
                  <div>
                    <h2 className="text-2xl font-bold text-[#FEC10E]">
                      {selectedJob.title}
                    </h2>
                    <p className="text-gray-600">{selectedJob.company}</p>
                  </div>
                </div>
                <pre className="mb-4 text-lg">{selectedJob.description}</pre>
                <p className="font-bold text-xl text-[#FEC10E]">
                  Hourly Pay: ${selectedJob.hourlyPay}
                </p>
              </div>
            ) : (
            ...
            <div className="bg-white p-6 rounded shadow-md w-1/3">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewJob({
                      ...newJob,
                      hourlyPay: parseFloat(e.target.value),
                    })
                  }
                />
              </div>
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewJob({ ...newJob, applicationLink: e.target.value })
                  }
                />
              </div>
              <div className="flex justify-end space-x-4">
                <button
                  ...
                  className="bg-[#FEC10E] text-white px-4 py-2 rounded shadow hover:bg-[#e0a90c]"
                >
                  Create
                </button>
                <button
